...
#  $Id: gistdemolow.py 640 2007-08-31 16:40:58Z mbec $
#  ---------------------------------------------------------------------
# 
#  NAME:    gistdemolow.py
#  CHANGES:
...
def a3(lb,ub,n):
   return reshape (array(n*span(lb,ub,n), float32), (n,n))
...
def span(lb,ub,n):
   ...
   return list(map(lambda x,A=a,B=b: A*x + B, list(range(n)))) # if you want a list
